...
2. Customize the project name by doing the following:
    ...
    * Customize the Java package name (`com.domain.package`) as follows:
        ...
        3. Adjust `package com.circular.android_background;` in the top of the `Module.java` and `Package.java` files in `android/src/main//java/package/path` to match it.
...
3. Link the library:
    ...
    * Add the following to `android/app/src/main/java/**/MainApplication.java`:
        ...
        import com.circular.android_background.Package;  // add this for react-native-android-library-boilerplate
